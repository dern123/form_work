        ...
        <div class="w-full flex justify-center items-center sm:flex-col">
            ...
            <div class="pl-6 block w-1/3 sm:p-0 sm:w-full">
                ...
                <form class="block bg-white sm:shadow-none sm:bg-transparent rounded-custom shadow-form text-primary overflow-hidden w-full pt-6 pb-4 px-6 sm:pt-2 sm:px-4 sm:leading-tight">
                    ...
                    <!-- <button id="myLinkModal" type = "button" class="btn-reg w-56 font-sans font-bold transition bg-btn-primary hover:bg-btn-hover text-white rounded py-3" name="button" type="button">проверить форму</button> -->
                    <button id="myLinkModal" type = "submit" class="btn-reg w-56 font-sans font-bold transition bg-btn-primary hover:bg-btn-hover text-white rounded py-3" name="button" type="button">отправить форму</button>
                    </div>

                    <div id="myModal" class="modal-noreg">
                         <p>Вы ранее уже были зарегистрированы<span id="myModal__close" class="close">ₓ</span></p>
                         <img class="icon-form hrest" src="./assets/landing/img/hrest.webp" alt="hrest" >
                    </div>
